...
-https://github.com/ardangoin/Project/blob/master/Diagrams/ELK%20Project%20Diagram.png

These files have been tested and used to generate a live ELK deployment on Azure. They can be used to either recreate the entire deployment pictured above. Alternatively, select portions of the _____ file may be used to install only certain pieces of it, such as Filebeat.

  - https://github.com/ardangoin/Project/blob/master/Ansible/ansible_playbook.yml
  - https://github.com/ardangoin/Project/blob/master/Ansible/ELK_ansible_Playbook.yml
  - https://github.com/ardangoin/Project/blob/master/Ansible/filebeat-playbook.yml
  - https://github.com/ardangoin/Project/blob/master/Ansible/metricbeat-playbook.yml
...
Machines within the network can only be accessed by the Jumbox.
- _TODO: Which machine did you allow to access your ELK VM? What was its IP address?
    The Elk VM is only accessable by the JumpBox (10.0.0.4)
